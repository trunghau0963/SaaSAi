      ...
      <div>
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              <h1
                className="text-4xl leading-8 font-bold tracking-tight text-white sm:text-6xl"
                style={{
              ...
              >
                ...
                <span>
                  <Typewriter
                    options={{
                      strings: ["Assistant", "Chatbot", "Generator", "Artificial Intelligence "],
                      autoStart: true,
                      loop: true,
                    }}
                  />
              ...
              <div className="mt-10 lg:flex items-center justify-center gap-x-6">
                <Link href="/dashboard">
                  <Button
                    className=" text-white gradient-btn w-full lg:w-auto mb-8 lg:mb-0"
                    size="lg"
                  >
                    Try Brainfast Free
                  </Button>
